...
ohlcv_histories_normalised_test = np.array([test_data['Adj Close'][i  : i + history_points].copy() for i in range(DAYS, remainder - history_points)])
next_day_open_values_normalised_test = np.array([test_data['Adj Close'][i + history_points].copy() for i in range(DAYS, remainder - history_points)])
next_day_open_values_normalised_test = np.expand_dims(next_day_open_values_normalised_test, -1)
 
 
next_day_open_values_test = np.array([test_data['Adj Close'][DAYS + i + history_points].copy() for i in range(remainder - history_points)])
